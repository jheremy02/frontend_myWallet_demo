...
import { handleActiveOption } from "../utils/styleSidebar";
      ...
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul className="space-y-2 font-medium">
          <li>
            <Link
              to={"/dashboard"}
              className={`flex items-center p-2 ${handleActiveOption(
                "/dashboard",
                location
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Operaciones</span>
            </Link>
          </li>
          <li>
            <Link
